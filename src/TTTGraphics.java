...
public class TTTGraphics extends JFrame {
    ...
    class GamePanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {  // Callback via repaint()
            ...
            //untuk mengubah background menjadi image
            String BACKGROUND_IMAGE = "assets/Lambang ITS.png";
            BufferedImage backgroundTTT;

            {
                try {
                    backgroundTTT = ImageIO.read(new File(BACKGROUND_IMAGE));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            }

            g.drawImage(backgroundTTT, 0, 0, BOARD_WIDTH, BOARD_HEIGHT, null);
